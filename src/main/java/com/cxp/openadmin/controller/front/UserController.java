...
@Api(value = "사용자 센터", tags = {"사용자 센터 관련 인터페이스"})
@RestController
...
public class UserController extends BaseController {
    ...
    @ApiOperation(value = "미니 프로그램 사용자 로그인",notes = "미니 프로그램 사용자 로그인",httpMethod = "POST")
    @PostMapping("/login")
    ...
    @ApiOperation(value = "애플릿 사용자의 휴대폰 번호 바인딩",notes = "애플릿 사용자의 휴대폰 번호 바인딩",httpMethod = "POST")
